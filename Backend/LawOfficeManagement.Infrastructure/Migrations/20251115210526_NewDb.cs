        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    JudgeName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId1 = table.Column<int>(type: "int", nullable: true),
                    CourtDivisionId1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cases_CourtDivisions_CourtDivisionId1",
                        column: x => x.CourtDivisionId1,
                        principalTable: "CourtDivisions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LawyerAttended = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ClientAttended = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CaseSession_NextSessionDate", "[NextSessionDate] IS NULL OR [NextSessionDate] > [SessionDate]");
                    table.CheckConstraint("CK_CaseSession_SessionDate", "[SessionDate] >= CAST(GETDATE() AS DATE)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cases_CourtDivisionId1",
                schema: "Cases",
                table: "Cases",
                column: "CourtDivisionId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseSessions_CaseId_SessionDate",
                schema: "Cases",
                table: "CaseSessions",
                columns: new[] { "CaseId", "SessionDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseSessions_SessionDate_SessionStatus",
                schema: "Cases",
                table: "CaseSessions",
                columns: new[] { "SessionDate", "SessionStatus" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseSessions_SessionType",
                schema: "Cases",
                table: "CaseSessions",
                column: "SessionType");
